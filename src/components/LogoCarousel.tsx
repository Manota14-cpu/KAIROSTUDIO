    ...
    return (
      ...
      >
        <AnimatePresence mode="wait">
          ...
          >
            <CurrentLogo className="clients-logo-svg" />
          </motion.div>
        </AnimatePresence>
      </motion.div>
    )
...
function LogoCarousel({ columnCount = 2 }: { columnCount?: number }) {
  ...
  const allLogos: Logo[] = useMemo(
    () => [
      ...
      { name: "OpenAI", id: 14, img: OpenAIIconWhite },
    ],
    []
  )
  ...
  return (
    <section className="clients-section container-main" aria-label="Clients">
      <div className="clients-carousel-root">
        <span className="clients-label">{t('clients.label')}</span>
        <h2 className="services-title">{t('clients.heading')}</h2>
...
/* ── SVG Icons (adapted for dark bg — white/currentColor) ── */
...
function BMWIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 498.503 498.503" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path fill="#fff" d="M8.624 249.251c0-64.272 25.03-124.699 70.479-170.148 45.449-45.45 105.875-70.479 170.148-70.479s124.7 25.029 170.148 70.479c45.449 45.449 70.479 105.875 70.479 170.148 0 132.683-107.945 240.628-240.627 240.628-64.273 0-124.699-25.03-170.148-70.479C33.654 373.95 8.624 313.524 8.624 249.251z" />
      ...
      <path fill="#fff" d="M249.251 396.621c-81.389 0-147.37-65.98-147.37-147.37 0-81.389 65.981-147.37 147.37-147.37 81.389 0 147.37 65.981 147.37 147.37 0 81.39-65.98 147.37-147.37 147.37z" />
...
function StripeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={512} height={214} viewBox="0 0 512 214" {...props}>
      <path fill="#FFC957" d="M512 110.08c0-36.409-17.636-65.138-51.342-65.138-33.85 0-54.33 28.73-54.33 64.854c0 42.808 24.179 64.426 58.88 64.426 16.925 0 29.725-3.84 39.396-9.244v-28.445c-9.67 4.836-20.764 7.823-34.844 7.823-13.796 0-26.027-4.836-27.591-21.618h69.547c0-1.85.284-9.245.284-12.658m-70.258-13.511c0-16.071 9.814-22.756 18.774-22.756c8.675 0 17.92 6.685 17.92 22.756zm-90.31-51.627c-13.939 0-22.899 6.542-27.876 11.094l-1.85-8.818h-31.288v165.83l35.555-7.537.143-40.249c5.12 3.698 12.657 8.96 25.173 8.96c25.458 0 48.64-20.48 48.64-65.564c-.142-41.245-23.609-63.716-48.498-63.716m-8.534 97.991c-8.391 0-13.37-2.986-16.782-6.684l-.143-52.765c3.698-4.124 8.818-6.968 16.925-6.968c12.942 0 21.902 14.506 21.902 33.137c0 19.058-8.818 33.28-21.902 33.28" />
    </svg>
  )
}
...
function ClaudeAIIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 512 512" {...props}>
...
function SupabaseIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 109 113" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g opacity=".3"><path d="M63.708 110.284c-2.86 3.601-8.658 1.628-8.727-2.97l-1.007-67.251h45.22c8.19 0 12.758 9.46 7.665 15.874l-43.151 54.347Z" fill="currentColor" /></g>
...
function OpenAIIconWhite(props: SVGProps<SVGSVGElement>) {
  return (
